// node_modules/@cynber/vitepress-valence/dist/photoswipe.esm-CClfKnLq.js
function f(r, t, i) {
...
var X = class {
   ...
   */
  remove(t, i, e, s) {
    this._toggleListener(t, i, e, s, true);
  }
  /**
...
var j = class {
   ...
   */
  sizeChanged(t, i) {
    return t !== this.prevDisplayedWidth || i !== this.prevDisplayedHeight ? (this.prevDisplayedWidth = t, this.prevDisplayedHeight = i, true) : false;
  }
...
var it = class {
  ...
  change() {
    ...
    if (this.pswp.animations.stopAll(), i.isShifted()) {
      ...
      t.x < -E && o < 0 || t.x < 0.1 && o < -0.5 ? (s = 1, t.x = Math.min(t.x, 0)) : (t.x > E && o > 0 || t.x > -0.1 && o > 0.5) && (s = -1, t.x = Math.max(t.x, 0)), i.moveIndexBy(s, true, t.x);
    }
    e && e.currZoomLevel > e.zoomLevels.max || this.gestures.isMultitouch ? this.gestures.zoomLevels.correctZoomPan(true) : (this._finishPanGestureForAxis("x"), this._finishPanGestureForAxis("y"));
  }
  /**
   * @private
   * @param {'x' | 'y'} axis
...
var nt = class {
  ...
  correctZoomPan(t) {
    ...
    let n, o = true;
    s < e.zoomLevels.initial ? n = e.zoomLevels.initial : s > e.zoomLevels.max ? n = e.zoomLevels.max : (o = false, n = s);
...
var lt = class {
  ...
  onPointerDown(t) {
    ...
    e.dispatch("pointerDown", {
      originalEvent: t
    }).defaultPrevented || (i && (e.mouseDetected(), this._preventPointerEventBehaviour(t, "down")), e.animations.stopAll(), this._updatePoints(t, "down"), this._numActivePoints === 1 && (this.dragAxis = null, p(this.startP1, this.p1)), this._numActivePoints > 1 ? (this._clearTapTimer(), this.isMultitouch = true) : this.isMultitouch = false);
  }
  /**
   * @param {PointerEvent} e
   */
  ...
  _updateVelocity(t) {
    ...
    e < 50 && !t || (this.velocity.x = this._getVelocity("x", e), this.velocity.y = this._getVelocity("y", e), this._intervalTime = i, p(this._intervalP1, this.p1), this._velocityCalculated = true);
  }
  /**
   * @private
   * @param {PointerEvent} e
  ...
  _preventPointerEventBehaviour(t, i) {
    this.pswp.applyFilters("preventPointerEvent", true, t, i) && t.preventDefault();
  }
  /**
...
var ft = class {
  ...
  constructor(t) {
    ...
    this._target = e, this._onComplete = s, this._finished = false, this._onTransitionEnd = this._onTransitionEnd.bind(this), this._helperTimeout = setTimeout(() => {
      R(e, l, a, h), this._helperTimeout = setTimeout(() => {
        e.addEventListener("transitionend", this._onTransitionEnd, false), e.addEventListener("transitioncancel", this._onTransitionEnd, false), this._helperTimeout = setTimeout(() => {
  ...
  destroy() {
    this._helperTimeout && clearTimeout(this._helperTimeout), U(this._target), this._target.removeEventListener("transitionend", this._onTransitionEnd, false), this._target.removeEventListener("transitioncancel", this._onTransitionEnd, false), this._finished || this._finalizeAnimation();
  }
};
var _t = 12;
var vt = 0.75;
  ...
  onInit: (r, t) => {
    ...
    const s = (a, h) => {
      ...
      if (!((a = t.currSlide) !== null && a !== void 0 && a.content.isLoading())) {
        n(false), e && (clearTimeout(e), e = null);
        return;
      }
      e || (e = setTimeout(() => {
        var h;
...
var zt = class {
  ...
  init() {
    ...
    this.isRegistered = false, this.uiElementsData = [At, It, bt, Lt, Ct, Tt], t.dispatch("uiRegister"), this.uiElementsData.sort((i, e) => (i.order || 0) - (e.order || 0)), this.items = [], this.isRegistered = true, this.uiElementsData.forEach((i) => {
  ...
  _onZoomPanUpdate() {
    ...
    if (Math.abs(n) < 0.01 || !i.isZoomable()) {
      D(t, false), t.classList.remove("pswp--zoom-allowed");
      return;
    }
...
var Ft = class {
  ...
  load(t, i) {
    ...
    this.element && !i || this.instance.dispatch("contentLoad", {
      content: this,
      isLazy: t
    }).defaultPrevented || (this.isImageContent() ? (this.element = f("pswp__img", "img"), this.displayedImageWidth && this.loadImage(t)) : (this.element = f("pswp__content", "div"), this.element.innerHTML = this.data.html || ""), i && this.slide && this.slide.updateContentSize(true));
  }
  /**
   * Preload image
   *
  ...
  displayError() {
    if (this.slide) {
      ...
      this.instance.applyFilters("contentErrorElement", e, this), this.element = f("pswp__content pswp__error-msg-container", "div"), this.element.appendChild(e), this.slide.container.innerText = "", this.slide.container.appendChild(this.element), this.slide.updateContentSize(true), this.removePlaceholder();
    }
  }
  /**
   * Append the content
...
var $t = class extends Ht {
  ...
  refreshSlideContent(t) {
    this.contentLoader.removeByIndex(t), this.mainScroll.itemHolders.forEach((i, e) => {
      ...
      if (this.canLoop() && (o = this.getLoopedIndex(o)), o === t && (this.setContent(i, t, true), e === 1)) {
        var a;
        this.currSlide = i.slide, (a = i.slide) === null || a === void 0 || a.setIsActive(true);
      }
...
@cynber/vitepress-valence/dist/photoswipe.esm-CClfKnLq.js:
  (*!
    * PhotoSwipe 5.4.4 - https://photoswipe.com
    * (c) 2024 Dmytro Semenov
    *)
*/
//# sourceMappingURL=photoswipe.esm-CClfKnLq-M27SJOUH.js.map
